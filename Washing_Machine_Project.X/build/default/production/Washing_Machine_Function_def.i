# 1 "Washing_Machine_Function_def.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Washing_Machine_Function_def.c" 2
# 1 "./main.h" 1
# 11 "./main.h"
...
# 15 "./main.h" 2
# 1 "./Washing_Machine_head.h" 1
# 11 "./Washing_Machine_head.h"
...
# 16 "./main.h" 2
# 2 "Washing_Machine_Function_def.c" 2
...
void power_on_screen(void) {
    ...
    clcd_putch(0xFF, (0x80 + 1));
    clcd_putch(0xFF, (0x80 + 2));
...
void washing_program_display(unsigned char key) {
   if (reset_flag == 0x11) {
    ...
    clcd_print(washing_program[(program_no + 1) % 12], (0x90 + 1));
    clcd_print(washing_program[(program_no + 2) % 12], (0xD0 + 1));
}
...
void run_program(unsigned char key) {
    ...
    if (reset_flag == 0x44) {
        ...
        clcd_print("Time", (0xC0 + 0));
        clcd_print("SW5: START ", (0x90 + 0));
        clcd_print("SW6: PAUSE", (0xD0 + 0));
    ...
    if (min == 0 && sec == 0) {
        ...
        RC2 = 0;
        RC1 = 1;
        clcd_print("ProgramCompleted", (0x80 + 0));
...
void door_status_check() {
    if(RB0 == 0) {
        ...
        clcd_print("Please close ",(0xC0 + 0));
        clcd_print("Door",(0x90 + 0));
